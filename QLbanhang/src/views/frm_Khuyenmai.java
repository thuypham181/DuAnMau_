...
public class frm_Khuyenmai extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnXoa.setBounds(750, 230, 120, 40);
        ...
        tb_khuyenmai.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Tên ", "Ngày bắt đầu", "Ngày kết thúc", "Giá trị giảm", "Trạng thái"
            }
        ));
...
//            Logger.getLogger(FrmKhuyenmai.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        int row = this.tb_khuyenmai.getSelectedRow();
        ...
        if (chon == JOptionPane.YES_OPTION) {
            int idStr =  (Integer) this.tb_khuyenmai.getValueAt(row, 0);
            this.khuyenmaiService.Delete(idStr);
            LoadData();

...
public class frm_Khachhang extends javax.swing.JPanel {
    ...
    private KhachHang getData() {
        ...
        cv.setDiaChi(txt_diaChi.getText());
        return cv;
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setBounds(390, 190, 210, 20);
        panelBorder1.add(txt_email);
        txt_email.setBounds(390, 160, 210, 30);
        ...
        btnXoa.setBounds(670, 200, 120, 40);
        panelBorder1.add(txt_diaChi);
        txt_diaChi.setBounds(390, 210, 210, 30);

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel10.setText("E-mail");
        panelBorder1.add(jLabel10);
        jLabel10.setBounds(390, 130, 210, 20);
        ...
        TB_bang1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Họ Và Tên", "Giới Tính", "Ngày Sinh", "SĐT", "Email", "Điểm Thưởng", "Địa Chỉ"
            }
        ));
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        int row = this.TB_bang1.getSelectedRow();
        ...
        if (chon == JOptionPane.YES_OPTION) {
            int idStr = (Integer) this.TB_bang1.getValueAt(row, 0);
            this.KH.delete(idStr);
            listKhachHang = KH.getall();
            showTable(listKhachHang);

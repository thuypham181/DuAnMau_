...
// Email        
    ...
    private void initComponents() {
        ...
        panelGradiente1.add(btnlmmoi, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 220, 120, 40));
        ...
        panelGradiente1.add(btnXoa, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 160, 120, 40));
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (chon == JOptionPane.YES_OPTION) {
            int idStr =  (Integer) this.tblnhanvien.getValueAt(row, 0);
            this.nhanVienService.delete(idStr);
            loaddata();

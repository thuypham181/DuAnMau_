...
public class HoaDonRepostory implements IHoaDonRepostory {
   ...
   @Override
    public List<HoaDon> GetAllHD() {
        String query = "SELECT a.MA,b.TEN,c.TEN,NGAYTAO,NGAYTHANHTOAN,TinhTrang,GHICHU,a.tongTien,c.Ho,c.tenDem FROM HOADON a JOIN USERS b ON a.IDNV = b.ID "
        ...
        try (Connection con = DBConnection.openDbConnection();
            ...
            while (rs.next()) {
                ...
                khachHang.setTen(rs.getString(9)+" "+rs.getString(10)+" "+rs.getString(3));
...
/////////////////////////////////////////////////
   ...
   int rs = 0;
    ...
    @Override
    public Integer deleteHD(String idHD) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public Integer deleteHDCT(String idHD) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

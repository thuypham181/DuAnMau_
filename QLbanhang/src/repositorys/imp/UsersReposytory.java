...
public class UsersReposytory implements IUsersReposytory {
    ...
    public List<Users> getAllNhanVien() {
        ...
        String sql = "SELECT Users.id,Users.Ten,TenDem,Ho,NgaySinh,Gioitinh,Sdt,IdCV,TaiKhoan,MatKhau,Email,ChucVu.Ten,Users.TrangThai FROM Users join ChucVu on ChucVu.Id = Users.IdCV";
